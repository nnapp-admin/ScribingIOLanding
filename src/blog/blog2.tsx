  ...
  return (
    <div className="relative p-6 bg-white rounded-3xl shadow-xl border border-gray-100">
      ...
      <div className="relative z-10">
        ...
        />
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Blog Post 2</h2>
        <p className="text-gray-600 mb-6">
          This is the content of blog post 2. Published on October 16, 2025 at 05:41 PM IST. Dive into the latest updates and insights from AI Scribe, designed to enhance your medical documentation experience.
        </p>
